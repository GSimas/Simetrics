/**
 * Lista de stop words em inglês do scikit-learn (`ENGLISH_STOP_WORDS`), 318 termos.
 *
 * Copiada literalmente em vez de aproximada por uma lista genérica: a vetorização TF-IDF
 * do pipeline Python usa `stop_words='english'`, e qualquer termo a mais ou a menos muda
 * os pesos, os pares de similaridade e, por consequência, o resultado da deduplicação.
 */
export const ENGLISH_STOP_WORDS: ReadonlySet<string> = new Set([
  ...
  'nine', 'no', 'nobody', 'none', 'noone', 'nor', 'not', 'nothing', 'now', 'nowhere', 'of',
