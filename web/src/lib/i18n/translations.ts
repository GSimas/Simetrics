...
export const TRANSLATIONS = {
  pt: {
    ...
    prod_axis_year: 'Ano',
    prod_axis_docs: 'Documentos',
    prod_unit_docs: 'documentos',
    top_title: 'Top 10',
    top_description:
      'Os dez autores, documentos, países e venues de maior destaque segundo a métrica escolhida em cada ranking. Médias e medianas favorecem entidades com poucos documentos muito citados. Clique num item para abrir seu perfil no Motor de Busca.',
    top_authors: 'Autores',
    top_documents: 'Documentos',
    top_countries: 'Países',
    top_venues: 'Venues',
    top_metric_label: 'Métrica',
    top_metric_citations: 'Citações',
    top_metric_cit_sum: 'Citações (soma)',
    top_metric_cit_mean: 'Citações (média)',
    top_metric_cit_median: 'Citações (mediana)',
    top_metric_docs: 'Documentos (soma)',
    top_metric_dpa_mean: 'Documentos por autor (média)',
    top_metric_dpa_median: 'Documentos por autor (mediana)',
    top_empty: 'Sem dados para este ranking.',
    top_open_hint: 'abrir no Motor de Busca',
    ...
    lotka_observed: 'Observado',
    lotka_theoretical: 'Teórico (Lotka)',
    lotka_article: 'artigo',
    lotka_articles: 'artigos',
    lotka_x_axis: 'Artigos publicados por autor',
    lotka_y_axis: 'Proporção de autores',
    lotka_description:
    ...
    network_radial_tab: 'Grafo radial',
    ...
    continent_unknown: 'Não identificado',
    ...
    settings_desc: 'Aparência, idioma, acessibilidade e chave de IA. Tudo fica salvo neste navegador.',
    settings_theme: 'Tema',
    settings_theme_dark: 'Escuro',
    settings_theme_light: 'Claro',
    settings_language: 'Idioma',
    settings_font: 'Tamanho da letra',
    settings_font_min: 'Mínimo',
    settings_font_med: 'Médio',
    ...
    settings_ticker: 'Faixa de indicadores',
    settings_ticker_scroll: 'Rolagem automática',
    settings_ticker_desc: 'Desligada, a faixa sob o cabeçalho fica parada. Também dá para pausar ou retomar clicando nela.',
    network_show_all_metrics: 'Ver todas as métricas',
    network_show_less: 'Mostrar menos',
    network_layout_force: 'Grafo de rede',
    export_image: 'Exportar imagem',
    chart_expand: 'Ampliar gráfico',
    chart_expanded_title: 'Visualização ampliada',
    chart_expanded_desc: 'O gráfico em tamanho maior, com as mesmas interações.',
    chart_zoom_in: 'Aproximar',
    chart_zoom_out: 'Afastar',
    chart_zoom_reset: 'Voltar ao tamanho original',
    chart_zoom_hint: 'Role o mouse para aproximar e arraste para mover',
    chart_3d_hint: 'Arraste para girar · role para aproximar',
    error_title: 'Não foi possível exibir este conteúdo',
    error_title_named: 'Não foi possível exibir {name}',
    error_desc: 'Um dado inesperado interrompeu a exibição. O restante do Simetrics continua funcionando.',
    error_chunk_desc: 'Não foi possível baixar esta parte do aplicativo — a conexão caiu ou há uma versão nova publicada.',
    error_retry: 'Tentar novamente',
    error_reload: 'Recarregar a página',
    error_back_projects: 'Voltar aos projetos',
    error_app: 'o Simetrics',
    error_tab: 'esta aba',
    error_chart: 'este gráfico',
    error_panel: 'este painel',
    chart_legend_toggle: 'Mostrar ou ocultar a série',
    chart_summary_series: '{count} séries de {from} a {to}.',
    chart_summary_total: 'Total: {total}; pico em {peak} ({value}).',
    chart_summary_points: '{count} pontos.',
    chart_summary_largest: 'Maiores',
    chart_summary_box: '{name}: mediana {median}, {count} valores',
    chart_summary_flows: '{nodes} termos e {links} fluxos entre períodos.',
    chat_send: 'Enviar pergunta',
    dedup_strategy_aria: 'Estratégia de deduplicação',
    network_loading_renderer: 'Carregando renderizador…',
    network_progress_label: 'Progresso da análise de rede',
    sigma_aria: 'Grafo de rede com {nodes} nós e {edges} ligações.',
    chart_most_connected: 'Mais conectados',
    loading: 'Carregando…',
    chart_brush_hint: 'Arraste sobre o gráfico para dar zoom · duplo clique desfaz',
    export_desc: 'Escolha o formato do arquivo.',
    export_svg: 'SVG',
    export_svg_hint: 'Vetorial, editável no Illustrator, Inkscape ou Figma.',
    export_jpg: 'JPG com fundo',
    export_jpg_hint: 'Imagem com o fundo do tema atual.',
    export_png: 'PNG sem fundo',
    export_png_hint: 'Fundo transparente, para slides e documentos.',
    export_unavailable: 'O gráfico ainda não terminou de ser desenhado.',
    map_aria: 'Mapa-múndi de colaboração com {count} países',
    map_partners: 'parceiros',
    map_click_highlight: 'Clique para destacar as conexões',
    map_click_open: 'Clique de novo para abrir o perfil',
    map_no_data: 'Sem documentos na base',
    search_tab_map: 'Mapa-múndi',
    search_coauthors: 'Coautores',
    ...
    // Blocos que abrem modais (padrão EcoGrad)
    info_how_to_read: 'Como ler',
    modal_close: 'Fechar',
    launcher_section: 'Aprofundar a análise',
    sum_prod: 'Documentos por ano — por país, base, tipo de trabalho ou tema.',
    sum_visual: 'Evolução temática, distribuição, genética das ideias, mapas conceitual e temático, historiograph e Lei de Lotka.',
    sum_theme: 'Agrupa os documentos em temas por similaridade textual, com rótulos por IA.',
    sum_tables: 'Rankings de autores, países, venues, palavras-chave e a lista completa de documentos.',
    ...
    landing_faq_a2:
      'Sim, totalmente gratuito e sem necessidade de cadastro. Os recursos de IA (categorização temática, assistente científica) são opcionais e usam a chave de API do próprio usuário (BYOK).',
  ...
  en: {
    ...
    prod_axis_year: 'Year',
    prod_axis_docs: 'Documents',
    prod_unit_docs: 'documents',
    top_title: 'Top 10',
    top_description:
      'The ten most prominent authors, documents, countries and venues according to the metric chosen in each ranking. Means and medians favour entities with few, highly cited documents. Click an item to open its profile in the Search Engine.',
    top_authors: 'Authors',
    top_documents: 'Documents',
    top_countries: 'Countries',
    top_venues: 'Venues',
    top_metric_label: 'Metric',
    top_metric_citations: 'Citations',
    top_metric_cit_sum: 'Citations (sum)',
    top_metric_cit_mean: 'Citations (mean)',
    top_metric_cit_median: 'Citations (median)',
    top_metric_docs: 'Documents (sum)',
    top_metric_dpa_mean: 'Documents per author (mean)',
    top_metric_dpa_median: 'Documents per author (median)',
    top_empty: 'No data for this ranking.',
    top_open_hint: 'open in Search Engine',
    ...
    lotka_observed: 'Observed',
    lotka_theoretical: 'Theoretical (Lotka)',
    lotka_article: 'article',
    lotka_articles: 'articles',
    lotka_x_axis: 'Articles published per author',
    lotka_y_axis: 'Share of authors',
    lotka_description:
    ...
    network_radial_tab: 'Radial graph',
    ...
    settings_desc: 'Appearance, language, accessibility and AI key. Everything is saved in this browser.',
    settings_theme: 'Theme',
    settings_theme_dark: 'Dark',
    settings_theme_light: 'Light',
    settings_language: 'Language',
    settings_font: 'Text size',
    settings_font_min: 'Small',
    settings_font_med: 'Medium',
    ...
    settings_ticker: 'Indicator strip',
    settings_ticker_scroll: 'Auto-scroll',
    settings_ticker_desc: 'When off, the strip below the header stays still. You can also pause or resume it by clicking it.',
    network_show_all_metrics: 'Show all metrics',
    network_show_less: 'Show less',
    network_layout_force: 'Network graph',
    export_image: 'Export image',
    chart_expand: 'Expand chart',
    chart_expanded_title: 'Expanded view',
    chart_expanded_desc: 'The chart at a larger size, with the same interactions.',
    chart_zoom_in: 'Zoom in',
    chart_zoom_out: 'Zoom out',
    chart_zoom_reset: 'Reset zoom',
    chart_zoom_hint: 'Scroll to zoom and drag to pan',
    chart_3d_hint: 'Drag to rotate · scroll to zoom',
    error_title: 'This content could not be displayed',
    error_title_named: 'Could not display {name}',
    error_desc: 'Unexpected data interrupted the display. The rest of Simetrics keeps working.',
    error_chunk_desc: 'This part of the app could not be downloaded — the connection dropped or a new version was published.',
    error_retry: 'Try again',
    error_reload: 'Reload page',
    error_back_projects: 'Back to projects',
    error_app: 'Simetrics',
    error_tab: 'this tab',
    error_chart: 'this chart',
    error_panel: 'this panel',
    chart_legend_toggle: 'Show or hide series',
    chart_summary_series: '{count} series from {from} to {to}.',
    chart_summary_total: 'Total: {total}; peak in {peak} ({value}).',
    chart_summary_points: '{count} points.',
    chart_summary_largest: 'Largest',
    chart_summary_box: '{name}: median {median}, {count} values',
    chart_summary_flows: '{nodes} terms and {links} flows between periods.',
    chat_send: 'Send question',
    dedup_strategy_aria: 'Deduplication strategy',
    network_loading_renderer: 'Loading renderer…',
    network_progress_label: 'Network analysis progress',
    sigma_aria: 'Network graph with {nodes} nodes and {edges} links.',
    chart_most_connected: 'Most connected',
    loading: 'Loading…',
    chart_brush_hint: 'Drag over the chart to zoom · double-click resets',
    export_desc: 'Choose the file format.',
    export_svg: 'SVG',
    export_svg_hint: 'Vector, editable in Illustrator, Inkscape or Figma.',
    export_jpg: 'JPG with background',
    export_jpg_hint: 'Image with the current theme background.',
    export_png: 'Transparent PNG',
    export_png_hint: 'Transparent background, for slides and documents.',
    export_unavailable: 'The chart has not finished drawing yet.',
    map_aria: 'World collaboration map with {count} countries',
    map_partners: 'partners',
    map_click_highlight: 'Click to highlight its connections',
    map_click_open: 'Click again to open the profile',
    map_no_data: 'No documents in the corpus',
    search_tab_map: 'World map',
    search_coauthors: 'Co-authors',
    ...
    // Blocks that open modals (EcoGrad pattern)
    info_how_to_read: 'How to read',
    modal_close: 'Close',
    launcher_section: 'Explore further',
    sum_prod: 'Documents per year — by country, database, document type or theme.',
    sum_visual: "Thematic evolution, distribution, genetics of ideas, conceptual and thematic maps, historiograph and Lotka's law.",
    sum_theme: 'Groups documents into themes by textual similarity, with AI labels.',
    sum_tables: 'Rankings of authors, countries, venues, keywords and the full document list.',
